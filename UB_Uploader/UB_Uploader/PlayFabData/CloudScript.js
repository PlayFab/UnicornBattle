...
handlers.SaveProgress = function (args) {
    ...
    balanceGoldVC.VirtualCurrency = GOLD_CURRENCY_CODE;
...
handlers.SubtractLife = function (args) {
    ...
    params.CharacterId = args.CharacterId;
    params.PlayFabId = currentPlayerId;
    params.VirtualCurrency = HEART_CURRENCY_CODE;
    params.Amount = 1;
...
function InitializeNewCharacterData(id, catalogCode) {
    ...
    balanceHeartVC.VirtualCurrency = HEART_CURRENCY_CODE;
    ...
    balanceGemVC.VirtualCurrency = GEM_CURRENCY_CODE;
