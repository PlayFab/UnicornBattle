...
public class OfferPromptController : MonoBehaviour {
	...
	public void ShowItemOffer(ItemInstance item)
	{
		...
		if(activeItem != null)
		{
			...
			Dictionary<string, string> customData = PlayFab.SimpleJson.DeserializeObject<Dictionary<string, string>>(activeItem.CustomData);
			...
			if(customData.ContainsKey("itemAwarded"))
			{
				...
				Dictionary<string, string> awardCustomData = PlayFab.SimpleJson.DeserializeObject<Dictionary<string, string>>(awardItem.CustomData);
		...
		if(details != null)
		{
			...
			if(details.ItemToGrant != null)
			{
				...
				if(grantItem != null)
				{
					...
					Dictionary<string, string> customData = PlayFab.SimpleJson.DeserializeObject<Dictionary<string, string>>(grantItem.CustomData);
