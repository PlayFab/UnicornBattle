		...
		if(PF_GamePlay.encounters != null)
		{
			...
			foreach(var item in nextSet)
			{
				if(frameCount == 3)
				{
					...
					// change icon
					this.encounterN1.encounterIcon.overrideSprite = GameController.Instance.iconManager.GetIconById(item.Data.Icon);
				...
				else if(frameCount == 2)
				{
					...
					// change icon
					this.encounterN2.encounterIcon.overrideSprite = GameController.Instance.iconManager.GetIconById(item.Data.Icon);
				...
				else if(frameCount == 1)
				{
					...
					// change icon
					this.encounterN3.encounterIcon.overrideSprite = GameController.Instance.iconManager.GetIconById(item.Data.Icon);
			...
			for(int z = frameCount; z > 0; z--)
			{
				if(z == 3)
				{
                    this.encounterN1.encounterIcon.overrideSprite = GameController.Instance.iconManager.GetIconById(GlobalStrings.DARKSTONE_STAR_ICON);
					this.encounterN1.encounterBanner.color = new Color(188,0,255,255);
					this.encounterN1.encounterName.text = string.Empty;
				}	
				else if(z == 2)
				{
                    this.encounterN2.encounterIcon.overrideSprite = GameController.Instance.iconManager.GetIconById(GlobalStrings.DARKSTONE_STAR_ICON);
					this.encounterN2.encounterBanner.color = new Color(188,0,255,255);
					this.encounterN2.encounterName.text = string.Empty;
				}	
				else if(z == 1)
				{
                    this.encounterN3.encounterIcon.overrideSprite = GameController.Instance.iconManager.GetIconById(GlobalStrings.DARKSTONE_STAR_ICON);
