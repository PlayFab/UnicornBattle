...
namespace UnicornBattle.Controllers
{
    public class NextEncounterController : MonoBehaviour
    {
        ...
        public void UpdateNextEncounters()
        {
            ...
            {
                List<UBEncounter> nextSet = GameController.Instance.ActiveEncounterList.Skip(1).Take(3).ToList();
                ...
                int encountersRemaining = GameController.Instance.ActiveEncounterList.Count - 4 > 0 ? GameController.Instance.ActiveEncounterList.Count - 4 : 0;
