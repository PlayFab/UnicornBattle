...
public class SpellSlot : MonoBehaviour
{
	...
	public UBSpell SpellData;

	public bool isOnCD;
	public bool isLocked;

	private int cdTurns;
	private UBSpellDetail baseSpell;
	...
	public void AddSpellData(string spName, UBSpellDetail sp, int spLvl)
	{
		if (sp == null)
			return;

		this.baseSpell = sp;
		this.SpellData = new UBSpell()
		{
			SpellName = spName,
		...
		if (GameController.Instance.ActiveCharacter.characterData.CharacterLevel < this.SpellData.LevelReq)
		{
			this.DisableCD();
			this.Lock();
		}
