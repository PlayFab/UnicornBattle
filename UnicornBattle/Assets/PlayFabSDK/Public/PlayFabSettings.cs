...
namespace PlayFab
{
    ...
    public static class PlayFabSettings
    {
        ...
        public static PlayFabLogLevel LogLevel = PlayFabLogLevel.All;
		...
		internal static string LogicServerUrl = "https://2ABE.playfablogic.com/1/prod"; // Assigned by GetCloudScriptUrl, used by RunCloudScript
