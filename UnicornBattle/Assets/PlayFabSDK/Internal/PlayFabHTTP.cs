...
//			Debug.LogWarning("WWW.out " + requestContainer.Url);
            WWW www = new WWW(fullUrl, bData, headers);

//            var preInvoke = string.Empty;
//            var postInvoke = string.Empty;

//			if(requestContainer.Url.Contains("ExecuteCloudScript"))
//            {
//				preInvoke = requestContainer.Url;
//
//				if(requestContainer.Data.Contains("UpdateCharacterStats"))
//				{
//					Debug.LogWarning(requestContainer.Data);
//				}
//			}
...
//			if(requestContainer.Url.Contains("ExecuteCloudScript"))
//            {
//				postInvoke = requestContainer.Url;
//			}
...
//            Debug.LogWarning("WWW.return ("+ (Time.time - elapsed).ToString() +")" + requestContainer.Url);
//			if(requestContainer.Data.Contains("UpdateCharacterStats"))
//            {
//				Debug.LogWarning("PreInvoke: " + preInvoke);
//				Debug.LogWarning("PostInvoke: " + postInvoke);
